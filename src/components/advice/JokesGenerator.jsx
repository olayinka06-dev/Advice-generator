...
const JokesGenerator = () => {
  ...
  return (
    <div className="bg-[var(--secondary-color)] flex flex-col gap-3 relative px-6 max-w-[500px] w-full py-3 rounded-2xl min-h-[48vh]">
      <div className="flex flex-col gap-2">
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="text-center">
              {jokeQoute && (
                <span className="text-[var(--text-color)] text-[20px]">
